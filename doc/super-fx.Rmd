...
_Effect sizes_ As can be seen in Figure \@ref(fig:ABFX), panel B, increasing $N$ reduced the variability of effect sizes but had little impact on the central tendency. The mean $\eta_{p}^2$ observed for $N_{313}$ was `r res['313', 'stats_fx'][[1]][,1][[1]]`, whereas for $N$ closest to the median sample size for the field (25 & 24 respectively) $\mu\:\eta_{p}^2$ = `r res['25', 'stats_fx'][[1]][,1][[1]]`. In contrast the standard deviations were more varied; $\sigma$ = `r res['313', 'stats_fx'][[1]][,1][[2]]` and `r res['25', 'stats_fx'][[1]][2,1][[1]]` respectively. Interestingly, the pattern of results was comparable for the LME approach. Although, the observed effect sizes were on average lower for the LME models (e.g. $N_{313}\:\mu\:r^2$ = `r res['313', 'stats_fx'][[1]][,2][[1]]`, the variability in observed effect size denisties was comparable between the two approaches at each level of $N$ (Figure \@ref(fig:ABFX), panel E). Given the increasing variability with decreasing N, it is unsurprising that there is a strong negative relationship between sample size and information loss (Figure \@ref(fig:ABFX), panel C). Collectively, these data show that any collection of typical AB experiments will produce a reasonable estimate of the underlying effect size, on average, however, any single experiment will yield an imprecise estimate. Therefore, aggregate effect sizes should be used for power calculations, rather than those from single experiments. The range of possible effect sizes appears rather small with our maximal N, therefore theoretical models for the AB should focus on explaining large, ubiquitous effects. 
